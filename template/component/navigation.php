<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">Project Management App</a>
    </div>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="template/user/user_create.php"><i class="fa fa-pencil-square-o fa-fw"></i> Create User</a>
                                </li>
                                <li>
                                    <a href="template/user/user_list.php"><i class="fa fa-list fa-fw"></i> List Users</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="template/user/create.php">Create</a>
                                </li>
                                <li>
                                    <a href="#">List Position</a>
                                </li>
                            </ul>
                        </li>
                        <li>
